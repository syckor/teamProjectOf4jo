...
if (vo == null) {%>
	...
	<div class="pengsu">
		<div class="container">
			<h3>Hot video</h3>
			<div class="video" style="position: relative; left: 150px; max-width: 100%; padding-bottom: 56.25%; height: 0;">				
				<iframe width="784" height="441"
					src="https://www.youtube.com/embed/-FNP6ZTDlzM?controls=0"
					frameborder="0"
	...
	<div class="top-brands">
		<div class="container">
			...
			<div class="sliderfig">
				<ul id="flexiselDemo1">
					<li><img src="resources/images/kakaofriends.jpg" alt=" "
						class="img-responsive" /></li>
					<li><img src="resources/images/linefriends.png" alt=" "
						class="img-responsive" /></li>
					<li><img src="resources/images/1300k.jpg" alt=" "
						class="img-responsive" /></li>
					<li><img src="resources/images/babosarang.jpg" alt=" "
						class="img-responsive" /></li>
					<li><img src="resources/images/7sung.jpg" alt=" "
						class="img-responsive" /></li>
				</ul>
			</div>
			<script type="text/javascript">
