...
if (vo == null) {%>
	...
	<div class="typo codes">
		<div class="container">
			...
			<div class="col-sm-2 goodsbutton" align="center">
				<a href="gregist.sajo"><input type="button" value="굿즈등록" id='input' /> </a>
				
				<a href="chart.sajo"><input type="button" value="판매차트" id='chart' /> </a>
				...
				<table class="redTable">
					...
					<tbody>
						<c:forEach items="${List }" var="getSellList">
							<tr>
								<td><fmt:parseDate value="${getSellList.bdate }"
										var="bdate" pattern="yyyy-MM-dd" /> <fmt:formatDate
										pattern="yyyy-MM-dd" value="${bdate }" /></td>
