			...
			<div class="container">
				<div class="col-md-5 contact-left">
						...
						<div class="col-md-7 contact-right">
							...
							<a id="dtime" class="not_import">예상 배송기간 : ${goods.dtime }</a><br/><hr/>
							</div>
...
<!-- 			mail.jsp의 qna 스타일가져오고 싶어서 아래div2개를 설정해 줬습니다. -->
			<div class="agile_mail_grids">
				...
				<tr><td colspan="3">
				<textarea  readonly="readonly" id="taliststyle" name="rcontent" required="">${review.RCONTENT }</textarea>	
				</td></tr>
				</table>
				</c:forEach><br/><br/>
<!-- 				리뷰 리스트 페이징 -->
...
<!-- 				리뷰 리스트 끝난 부분 -->
				...
				<tr><td><textarea id="reviewarea"  name="rcontent" required=""></textarea></td></tr></table>
						<input type="hidden" id="bno" name="bno" value=${bno }>
						<input type="hidden" name="gid" value=${goods.gid } >
						<input type="hidden" id="score" name="score" value="">
						<input  type="submit" class="button1" placeholder="리뷰를 작성해주세요~" value="리뷰등록">
