...
<!--              				일단 purchase실행 하게하기위해 작성하긴 하는데 -->
       ...
       <div id="ppp" align="center">
   		<%if(vo==null){ %> 
               <a href="#" data-toggle="modal" data-target="#myModal88"><input type="submit" class="sbmincart-submit"  value="구매하기"
